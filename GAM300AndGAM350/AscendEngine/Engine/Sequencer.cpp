...
BaseHandle Sequencer::Deserialize(const GameObject& gameObject, Deserializer& deser)
{
...
void Sequencer::Serialize(Serializer& serializer, BaseHandle handle)
{
...
void Sequencer::Reflect(BaseHandle hdl, const Reflector& reflector)
{
...
/*
BaseHandle Sequencer::CloneComponent(BaseHandle)
{
	return BaseHandle();
}
*/
BaseHandle Sequencer::CreateComponent()
{
...
void Sequencer::DestroyComponent(BaseHandle hdl)
{
	/*TagHandle thdl(hdl);
...
void Sequencer::InitComponent(const GameObject& go, BaseHandle hdl)
{
}



void Sequencer::HandleMsg(MsgData_Base*)
{
}
